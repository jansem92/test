...
const Container = ({children, menuName = 'Dashboard', contentName = 'Content Name',hideContentHeader = false, subHeaderLoading = false, onClick1 = ()=>{}, onClick2 = ()=>{}, onClick3 = ()=>{}}) => (
  <>
    {
      subHeaderLoading ? (
        ...
        <div className="kt-subheader   kt-grid__item overider_kt_subheader" id="kt_subheader" style={{zIndex: 10}}>
          <div className="kt-subheader__main">
